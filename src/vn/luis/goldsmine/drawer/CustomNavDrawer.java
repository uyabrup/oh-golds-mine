package vn.luis.goldsmine.drawer;
...
public class CustomNavDrawer extends ArrayAdapter<NavDrawerItem> {

    private LayoutInflater inflater;
   
    public CustomNavDrawer(Context context, int textViewResourceId, NavDrawerItem[] objects ) {
